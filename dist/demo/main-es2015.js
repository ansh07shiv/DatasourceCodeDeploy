...
let CrudService = class CrudService {
    ...
    uploadData(e) {
        ...
        const fileDetails = {
            ...
            filePath: "C:\\Users\\TRANS20-LAP-RA2\\Downloads\\" + fileName
        };
...
module.exports = __webpack_require__(/*! C:\Users\TRANS20-LAP-RA2\Desktop\Jeswini\DataSource-master\DataSource\UI\src\main.ts */"zUnb");
...
let DataSourceService = class DataSourceService {
    ...
    saveAction(funParam) {
        ...
        console.log(this.variable.listOfDraggedFiles);
        console.log("If Condition Variable");
        console.log(this.variable.popupSubTitle);
        if (this.variable.popupSubTitle === 'merge') {
            ...
            if (this.variable.popupSubTitle !== 'encode') {
                //Updated Code to Pass File List
                console.log("In Sort Condition Sending Params");
                console.log("Data Passed Below");
                console.log(this.variable.outputTable.data);
                param = {
            ...
            const param = {
                ...
                "mergeColumn": "",
                "projectColumns": [],
                "outputFileName": "C:\\Users\\TRANS20-LAP-RA2\\Downloads\\Output.png",
                "sortColumnNames": [],
                "encodingColumns": [],
                "jsonData": this.variable.outputTable.data.length ? JSON.stringify(this.variable.outputTable.data) : JSON.stringify([])
            };
            this.crud.handleMergeAction('/action/', param).subscribe(resp => {
                ...
                if (this.variable.popupSubTitle !== 'decision tree') {
                    console.log("In Place where setting up Data");
                    console.log(resp);
                    // @ts-ignore
